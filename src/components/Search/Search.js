...
const Search = () => {
  return(
    <div className={s.searchPanel}>
      <form>
        <label>
          <input type="search" className={s.searchPanel__input} placeholder="Search products" />
          <svg className={s.searchPanel__icon} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
